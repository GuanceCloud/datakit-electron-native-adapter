...
function nativeRuntimeDirectory() {
  ...
  return value("GUANCE_NATIVE_RUNTIME") ||
    path.resolve(projectRoot, "../../..", "native/darwin/runtime");
}
...
function nativeSettings() {
  return {
    ...
    actionTrackingEnabled: boolean("GUANCE_NATIVE_ACTION_TRACKING", true),
...
ipcMain.handle("app:get-info", () => ({
  ...
  nativeSettings: activeNativeSettings
    ? {
        ...
        actionTrackingEnabled: activeNativeSettings.actionTrackingEnabled,
