      ...
      <div class="settings-main">
        <section class="panel settings-section">
          ...
          <dl class="settings-table">
            ...
            ${settingRow('Automatic Native Actions', enabledLabel(appInfo.nativeSettings?.actionTrackingEnabled))}
...
root.addEventListener('click', (event) => {
  ...
  if (action === 'navigate') {
    ...
    void window.orbitDesk?.openAuxiliaryWindow().then(({ webContentsID }) => {
      ...
      reportError(new Error(message), { action: 'open_auxiliary_window' })
